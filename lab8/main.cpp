// main.cpp — Lab 8 demo (Akarsh Garg, YOUR_ROLL_NO, Section B, 2nd Year)
//
// Runs the transaction manager through six bank-account scenarios:
...
int main() {
    ...
    std::cout << "Akarsh Garg | YOUR_ROLL_NO | Section B | 2nd Year\n";
    ...
    section("0) Seed alice=1000, bob=500, carol=750");
    {
        ...
        check(bank.commit(s) == Result::Ok, "initial data committed");
