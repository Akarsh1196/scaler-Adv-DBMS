...
int main() {
    std::cout << "Starting ClockSweep cache with capacity 3...\n";
    ClockSweep<int> cache(3);

    std::cout << "Adding keys 1, 2, 3...\n";
    cache.putKey(1);
    cache.putKey(2);
    cache.putKey(3);
    ...
    std::cout << "Adding key 4 (causes eviction of 2, since 1 is referenced)...\n";
    cache.putKey(4);
    cache.printCacheState();

    std::cout << "Adding key 5 (causes eviction of 3)...\n";
    cache.putKey(5);
    cache.printCacheState();
